...
exports.cleanPasswordArray = exports.deletePasswordArray = void 0;
...
const cleanPasswordArray = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const returnCleanPassword = data === null || data === void 0 ? void 0 : data.map(item => {
        let { dataValues } = item;
...
exports.cleanPasswordArray = cleanPasswordArray;
