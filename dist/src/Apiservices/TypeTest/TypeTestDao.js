...
const postDao = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield TypeTest.create(data);
    }
    catch (error) {
        console.log("🚀 ~ file: TypeTestDao.ts:57 ~ postDao ~ error:", error);
    }
});
exports.postDao = postDao;
const updateDao = (data, id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield TypeTest.update(data, { where: { id: id } });
    }
    catch (error) {
