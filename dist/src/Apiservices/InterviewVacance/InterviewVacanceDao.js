...
const getDao = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return yield InterviewVacance.findAll({});
});
...
const postDao = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield InterviewVacance.create(data);
    }
    catch (error) {
        console.log("🚀 ~ file: InterviewVacanceDao.ts:57 ~ postDao ~ error:", error);
    }
});
...
const updateDao = (data, id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield InterviewVacance.update(data, { where: { id: id } });
    }
    catch (error) {
