...
exports.rootFormateDtoo = exports.formaterDataAuth = void 0;
const formaterDataAuth = (dataU) => {
...
exports.formaterDataAuth = formaterDataAuth;
const rootFormateDtoo = (dataU) => {
    const result = Array.from(new Set(dataU.map((item) => item["table_name"])));
    const dataFormaterArray = result.reduce((acc, element) => {
        const filterDataColumns = dataU.filter((item) => item.table_name === element);
...
exports.rootFormateDtoo = rootFormateDtoo;
