...
const CVNextRouter_1 = __importDefault(require("./routes/CVNextRouter"));
...
const RoadMapVacancies_1 = __importDefault(require("./routes/RoadMapVacancies"));
const Roots_1 = __importDefault(require("./routes/Roots"));
const InterviewRroadMapRouter_1 = __importDefault(require("./routes/InterviewRroadMapRouter"));
const AssistantGetRouter_1 = __importDefault(require("./routes/AssistantGetRouter"));
...
app.use('/CVNext', CVNextRouter_1.default);
...
app.use('/InterviewRoadMaps', InterviewRroadMapRouter_1.default);
app.use('/RoadMap', RoadMap_1.default);
app.use('/RoadMapVacancies', RoadMapVacancies_1.default);
app.use('/Auth', auth_1.default);
app.use('/Roots', Roots_1.default);
app.use('/AssistantGet', AssistantGetRouter_1.default);
exports.default = app;
