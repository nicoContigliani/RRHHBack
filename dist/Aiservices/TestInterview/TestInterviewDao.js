...
const getDao = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return yield TestInterview.findAll({});
});
...
const postDao = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield TestInterview.create(data);
    }
    catch (error) {
        console.log("🚀 ~ file: TestInterviewDao.ts:57 ~ postDao ~ error:", error);
    }
});
exports.postDao = postDao;
const updateDao = (data, id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield TestInterview.update(data, { where: { id: id } });
    }
    catch (error) {
